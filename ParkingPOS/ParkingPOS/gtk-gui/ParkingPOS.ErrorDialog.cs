...
namespace ParkingPOS
{
	public partial class ErrorDialog
	{
		...
		protected virtual void Build()
		{
			...
			// Widget ParkingPOS.ErrorDialog
			this.Name = "ParkingPOS.ErrorDialog";
			this.Title = global::Mono.Unix.Catalog.GetString("dialog1");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child ParkingPOS.ErrorDialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child ParkingPOS.ErrorDialog.ActionArea
